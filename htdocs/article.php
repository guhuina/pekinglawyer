...
<title>刑事辩护网_<?php echo $tt['a_title2'];?></title>
...
<?php require_once('left.php'); ?>
  <div class="fl_r">
     ...
     <div class="title_word fl_l"><?php echo $xlr['class_title2'];?></div>
        <div class="more fl_r">当前位置：<a href="index.php">首页</a> > <a href="news.php?cid=<?php echo $cid;?>"><?php echo $xlr['class_title2'];?></a> > 文章内容</div>
    ...
    <div class="bg7">
       ...
       <div class="news_fb">发表于 <?php echo $tt['createtime'];?> | 来源：北京刑事辩护网 </div>
       <div class="news_nr">
