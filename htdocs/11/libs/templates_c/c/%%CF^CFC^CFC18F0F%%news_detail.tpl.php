<?php /* Smarty version 2.6.10, created on 2009-07-23 13:28:16
...
width=960 border=0 align=center cellPadding=0 cellSpacing=0 class=top_Path style="WORD-BREAK: break-all">
  ...
  <TR>
    ...
    <TD height="30">您现在的位置：&nbsp;<A class=LinkPath 
      href="index.php">北京律师维权网</A>&nbsp;&gt;&gt;&nbsp;<a href="index.php">首页</a> &gt;&gt; <a href="news.php?types=<?php echo $this->_tpl_vars['types']; ?>
            ...
            <td height="1074" valign="top"><table width="751" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
			  ...
			  <tr>
			    <td height="1060" colSpan=3 valign="top" ><table width="713" border="0" align="center" cellpadding="0" cellspacing="0" class="channel_border">
                  <tr>
                    <td width="711" height="870" valign="top"><table width="675" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
...
<table width="713" border="0" align="center" cellpadding="0" cellspacing="0" class="channel_border">
                  <tr>
                    <td width="711" height="50" valign="top"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="13%">&middot;上一个：</td>
                        <td width="87%"><a href="news_detail.php?id=<?php echo $this->_tpl_vars['lastid']; ?>
"><?php echo $this->_tpl_vars['subject1']; ?>
</a></td>
                      </tr>
                      <tr>
                        <td>&middot;下一个：</td>
                        <td><a href="news_detail.php?id=<?php echo $this->_tpl_vars['nextid']; ?>
