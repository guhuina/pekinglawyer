...
<HTML><HEAD><TITLE>北京律师维权网——后台管理</TITLE>
...
<FRAMESET id=frame border=false frameSpacing=0 rows=* frameBorder=1 cols=175,* scrolling="no">
	<FRAME name=left marginWidth=0 marginHeight=0 src="<?php echo $this->_tpl_vars['left_url']; ?>
?adminjob=left#" scrolling="yes">
	<FRAME name=main src="<?php echo $this->_tpl_vars['right_url']; ?>
">
