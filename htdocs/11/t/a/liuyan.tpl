	...
	<tr>
		<td>
			<table width=100% cellspacing=1 cellpadding=6>
				...
				<td class=b><a href="confirm.php?url=^$userid.url^">删除</a>&nbsp;&nbsp;<a href="liuyan_detail.php?id=^$userid.id^">详细内容</a>&nbsp;&nbsp;<a href="review.php?id=^$userid.id^">回复</a></td>
				</tr>
			  ^/foreach^
		  </table>
		</td>
...
<tr><td align=left><div align="center"><a href="?page_now=1"><font face="webdings">9</font></a> <a href="?page_now=^$before_page^"><font face="webdings">7</font></a>&nbsp;跳转:
      <input type='text' size='2' style='height: 16px; border:1px solid #E7E3E7' onkeydown="javascript: if(event.keyCode==13) location='?page_now='+this.value;"> 
        <a href="?page_now=^$after_page^"><font face="webdings">8</font></a> <a href="?page_now=^$pages^"><font face="webdings">:</font></a> &nbsp;页码: ( ^$page_now^/^$pages^ 总页数 )&nbsp;&nbsp;^$page_recs^/页&nbsp;共^$total_user^条记录</div></td>
<td align=right>
</td></tr>
</table>
