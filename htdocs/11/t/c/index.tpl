...
width=960 border=0 align=center cellPadding=0 cellSpacing=0 class=top_Path style="WORD-BREAK: break-all">
  ...
  <tr>
    <td><table width="960" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="200" valign="top" >^include file="left.tpl"^</td>
          ...
          <!--  <TABLE width="706" height="161" 
            border=0 align=center cellPadding=0 cellSpacing=5>
			  ...
			  ^foreach from=$array item=aa^
                <TD width="696" height="156" align=middle><a href="img_detail.php?id=^$aa.id^&types=1"><IMG class=pic1 height=145 
              ...
              <table width="100%" height="110" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td id=other1><table width="706" height="161" border="0" cellpadding="0" cellspacing="0" id="demo1">
                      <tr> ^foreach from=$array item=aa^
                        <td><table width="157" height="121" border="0" align="left" cellpadding="0" cellspacing="0">
                              <tr>
                                <td height="110"><a href="img_detail.php?id=^$aa.id^&types=1"><IMG class=pic1 height=145 
                  src="../../uploads/^$aa.czyear^" 
                  width=115 border=0></a></td>
                                <td>&nbsp;</td>
                              </tr>
                  ...
                  border=0>
					  ^foreach from=$userarray item=aa^ 
                        ...
                        src="../../images/client\Article_common7(2).gif"></td>
                          <td width="321" align=left valign="top"><a href="news_detail.php?id=^$aa.id^&types=1">^$aa.subject^</a></td>
                        </tr>^/foreach^
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD vAlign=top align=middle colSpan=2 height=255>
                  ...
                  border=0>
					  ^foreach from=$userarray1 item=aa^ 

                        <tr>
                          <td colspan=2 align=left valign="top"><IMG alt=普通信息 
                        src="../../images/client\Article_common7(2).gif"></td>
                          <td width="329" align=left valign="top"><a href="news_detail.php?id=^$aa.id^&types=2">^$aa.subject^</a></td>
                        </tr>^/foreach^
      ...
      cellSpacing=0 bgColor=#ffffff style="WORD-BREAK: break-all">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  border=0>
					  ^foreach from=$userarray2 item=aa^ 

                        <tr>
                          <td colspan=2 align=left valign="top"><IMG alt=普通信息 
                        src="../../images/client\Article_common7(2).gif"></td>
                          <td width="334" align=left valign="top"><a href="news_detail.php?id=^$aa.id^&types=5">^$aa.subject^</a></td>
                        </tr>^/foreach^
      ...
      cellSpacing=0 bgColor=#ffffff style="WORD-BREAK: break-all">
                  ...
                  href="http://www.bjmslawyer.com/ystx/"></a></td>
                              ...
                              <tr>
                                <td valign=top align=middle colspan=2 height=305><table cellspacing=0 cellpadding=0 width="100%" align=center 
                  border=0>
                                  ^foreach from=$userarray3 item=aa^
                                  <tr>
                        <td colspan=2 align=left valign="top"><IMG alt=普通信息 
                        src="../../images/client\Article_common7(2).gif"></td>
                                    <td width="334" align=left valign="top"><a href="news_detail.php?id=^$aa.id^&types=7">^$aa.subject^</a></td>
                                  </tr>
                                  ^/foreach^
                                </table></td>
                              </tr>
      ...
      cellSpacing=0 bgColor=#ffffff style="WORD-BREAK: break-all">
              ...
              <TBODY>
                ...
                <TR>
                  ...
                  border=0>
					  ^foreach from=$userarray4 item=aa^ 
                        <tr>
                          <td colspan=2 align=left valign="top"><IMG alt=普通信息 
                        src="../../images/client\Article_common7(2).gif"></td>
                          <td width="95%" align=left valign="top"><a href="news_detail.php?id=^$aa.id^&types=3">^$aa.subject^</a></td>
                        </tr>^/foreach^
                        ...
                        align=center border=0>
                              <TBODY>
                                <TR vAlign=top>
								^foreach from=$array4 item=aa^
                                  <TD align=middle valign="bottom"><A class="" title=^$aa.subject^ 
                              href="news_detail.php?id=^$aa.id^&types=3" 
      ...
      cellSpacing=0 bgColor=#ffffff style="WORD-BREAK: break-all">
              ...
              <TBODY>
                ...
                <TR>
                  ...
                  border=0>
					  ^foreach from=$userarray5 item=aa^ 

                        <tr>
                          <td colspan=2 align=left valign="top"><IMG alt=普通信息 
                        src="../../images/client\Article_common7(2).gif"></td>
                          <td width="95%" align=left valign="top"><a href="news_detail.php?id=^$aa.id^&types=4">^$aa.subject^</a></td>
                        </tr>^/foreach^
                        ...
                        align=center border=0>
                              <TBODY>
                                <TR vAlign=top>
                                  ^foreach from=$array5 item=aa^
								  <TD align=middle><A class="" 
                               title=^$aa.subject^
                              href="news_detail.php?id=^$aa.id^&types=4" 
                              target=_blank><IMG class=pic1 height=90 
                              src="../../uploads/^$aa.pic^" 
                              width=130 border=0></A><BR>
                                    <A class="" 
