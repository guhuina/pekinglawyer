...
width=960 border=0 align=center cellPadding=0 cellSpacing=0 class=top_Path style="WORD-BREAK: break-all">
  ...
  <TR>
    ...
    <TD height="30">您现在的位置：&nbsp;<A class=LinkPath 
      href="index.php">北京律师维权网</A>&nbsp;&gt;&gt;&nbsp;<a href="index.php">首页</a> &gt;&gt; <a href="news.php?types=^$types^">^$name^</a> &gt;&gt; 详细信息 </TD>
        ...
        <td valign="top"><table width="755" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="1074" valign="top"><table width="751" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
			  ...
			  <tr>
                <td width="725" colSpan=3 align="center" class="channel_font STYLE1" >^$subject^</td>
              </tr>
			  <tr>
                  ...
                  <tr>
                    <td width="711" height="50" valign="top"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="87%"><a href="news_detail.php?id=^$lastid^">^$subject1^</a></td>
                      </tr>
                      <tr>
                        <td>&middot;下一个：</td>
                        <td><a href="news_detail.php?id=^$nextid^">^$subject2^</a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table>
