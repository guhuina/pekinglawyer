...
width=960 border=0 align=center cellPadding=0 cellSpacing=0 class=top_Path style="WORD-BREAK: break-all">
  ...
  <TR>
    ...
    <TD height="30">您现在的位置：&nbsp;<A class=LinkPath 
      href="index.php">北京律师维权网</A>&nbsp;&gt;&gt;&nbsp;<a href="index.php">首页</a> &gt;&gt; <a href="flfg_more.php?type=^$type^">^$name^</a> &gt;&gt; 详细信息 </TD>
  ...
  <tr>
    <td><table width="960" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="200" height="1074" valign="top">^include file="left1.tpl"^</td>
        <td valign="top"><table width="755" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="1028" valign="top"><table width="751" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
               <TR>
			  ...
			  <tr>
			    <td height="953" colSpan=3 valign="top" ><table width="713" border="0" align="center" cellpadding="0" cellspacing="0" class="channel_border">
                  <tr>
                    <td width="711" height="945" valign="top"><table width="675" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
