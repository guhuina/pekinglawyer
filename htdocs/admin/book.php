...
<table width="90%" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="#BDDFDB">
  ...
  <tr>
    ...
    <td width="14%" align="center" bgcolor="#009999"><span class="STYLE1">留言标题</span></td>
  ...
  <?php
 $query=$wz->selectpg("book"," id desc ",15,$page);
 while($rs=mysql_fetch_array($query)){
  ...
  <tr >
    ...
    <td align="center"><a href="book_edit.php?id=<?PHP echo $rs['id'];?>">查看详细</a></td>
  </tr>
  <?php
  }
  ?>
