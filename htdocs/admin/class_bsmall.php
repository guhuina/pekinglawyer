...
if(isset($_GET['cid'])){
	...
	$bsqlstr="select webpage from n_class where cid=".$b_id;
	$bquery=mysql_query($bsqlstr);
	$brs=mysql_fetch_array($bquery);
	$bwebpage=$brs['webpage'];
...
if(isset($_POST['Submit'])){
	...
	//exit();
	$bigclass->insert("n_class","sortnum,class_title,class_title2,flag,keywords,author,content2,content,b_id,is_add,is_jian,is_link,is_pic,is_neirong","$sortnum,'$class_title','$class_title2',$flag,'$keywords','$author','$content2','$content',$b_id,$is_add,$is_jian,$is_link,$is_pic,$is_neirong");
	$bigclass-> update("n_class"," where cid=$inid");
...
if(isset($_POST['cid'])){
	...
	$bigclass-> update("n_class","b_id=$b_id,sortnum=$sortnum,class_title='$class_title',class_title2='$class_title2',flag=$flag,keywords='$keywords',author='$author',content2='$content2',content='$content',is_add=$is_add,is_jian=$is_jian,is_link=$is_link,is_pic=$is_pic,is_neirong=$is_neirong","where cid=$cid");
...
<table width="100%" border="1" align="center" cellpadding="5" cellspacing="0">
  ...
  if(isset($_GET['page'])){
   ...
   $query=$bigclass->selectpg("n_class","sortnum asc,cid desc ",20,$page,"where b_id=$b_id");
	  ...
	  ?>
		  <tr>
			...
			<td align="center">
					...
					echo "<a href='class_small.php?cid=".$row['cid']."'>下级管理</a>";
					}
					?>			</td>
			<td align="center">
           <a href="pic.php?cid=<?php echo $row['cid'];?>">上传</a>			
		   </td>
...
<form id="form1" name="form1" method="post" action="" onSubmit="return ckfrm();">
  <table width="605" border="1" align="center" cellpadding="5" cellspacing="0">
    <tr>
      ...
      <td><input name="sortnum" type="text" id="sortnum" value="<?php echo $maxsort;?>" size="4" /><?php echo $maxsort;?>      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="radio" name="flag" value="1" />
        ...
        无&nbsp;<input name="flag" type="radio" value="2" />
        混合</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="gn01" type="checkbox" id="gn01" value="1">
        ...
        禁止内容简介 
        <input name="gn03" type="checkbox" id="gn03" value="1" checked>
禁止友情链接 
...
有
  <input name="flag" type="radio" value="0" <?php if($rsedit['flag']==0){
		...
		?> />
无 
<input name="flag" type="radio" value="2" <?php if($rsedit['flag']==2){
		echo "checked=checked";} 
		?> /> 
混合</td>
    </tr>
