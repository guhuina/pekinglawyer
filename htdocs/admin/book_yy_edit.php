...
$query=$wz->selectedit("book_yy","where id=$id");
...
<table width="90%" border="0" align="center" cellpadding="7" cellspacing="1">
  ...
  <tr>
    <td align="right" valign="top" bgcolor="#F2FDFC">设计师:</td>
    <td bgcolor="#F4E6FF"><?php 
	$row=mysql_fetch_array(mysql_query("select * from n_article where a_id='$uid'"));
	echo $row['a_title2'];
	?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td bgcolor="#F4E6FF"><a href="book_yy.php">返回上页</a></td>
  </tr>
</table>
</body>
</html>
