...
if(isset($_POST['Submit'])){
   ...
   $maxcid=$maxrs[0]+1;
	...
	$bigclass-> update("n_class","webpage='$webpage'","where cid=$bcid");
...
if(isset($_POST['cid'])){
	...
	$bigclass-> update("n_class","b_id=$b_id,sortnum=$sortnum,class_title='$class_title',class_title2='$class_title2',tuijian=$tuijian,flag=$flag,keywords='$keywords',author='$author',content2='$content2',content='$content',is_add=$is_add,is_jian=$is_jian,is_link=$is_link,is_pic=$is_pic,is_neirong=$is_neirong","where cid=$cid");
...
<table width="100%" border="1" align="center" cellpadding="5" cellspacing="0">
  ...
  if(isset($_GET['page'])){
   ...
   $query=$bigclass->selectpg("n_class","sortnum asc,cid desc ",16,$page,"where b_id=$b_id");
...
无 </td>
    ...
    <tr>
      ...
      <td><input type="radio" name="tuijian" value="0" <?php if($rsedit['tuijian']==0){
		...
		?> />
        推荐
        <input name="tuijian" type="radio" value="2" <?php if($rsedit['tuijian']==2){
		echo "checked=checked";} 
		?> />
        重点推荐 </td>
    </tr>
